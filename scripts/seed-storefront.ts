...
async function seedData() {
  ...
  const seedCategories = [
    { id: 1, title: 'Mobile Games', logo: '/images/ml.png', game_slug: 'mobile-legends', sort_order: 1, is_active: true },
    { id: 2, title: 'PC Games', logo: '/images/val.png', game_slug: 'valorant', sort_order: 2, is_active: true },
    { id: 3, title: 'Voucher', logo: '/images/steam.png', game_slug: 'steam-wallet', sort_order: 3, is_active: true },
    { id: 4, title: 'Entertainment', logo: '/images/netflix.png', game_slug: 'netflix', sort_order: 4, is_active: true },
  ];
